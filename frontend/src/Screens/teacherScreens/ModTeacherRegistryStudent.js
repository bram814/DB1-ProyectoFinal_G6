...
export const ModTeacherRegistryStudent = () => {
  ...
  return (
    <div>
      <button className="btn btn-success button-74 animate__animated animate__fadeInTopLeft"  onClick={() => navigate("/teacherPublications")}>
        Teacher
      </button>
